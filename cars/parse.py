...
def parse_cars(list_of_pages:list):
    ...
    for list_ in list_of_pages:
        ...
        # print(categories_str)
            ...
            #     # print(CarBrand.objects.values_list('brand_name'))
            #     list_brands = CarBrand.objects.values_list('brand_name')
                
            #     # list_brands = [x.brand_name for x in list_brands]
            #     print(list_brands)
            #     result = re.match(r'AV', list_brands)
            #     print(result)
            ...
            #                              ).exists():
                #     continue
                # list_of_results.append(dict_of_result_one)
