...
urlpatterns = [
    ...
    path('list_cars/<int:pk>/',CarDetailView.as_view({'get':'retrieve'}),name='cars_detail_url'),
    path('list_brands/',BrandListView.as_view({'get':'list'}),name='list_brand_url'),
    path('list_brands/<int:pk>/',BrandDetailView.as_view({'get':'retrieve'}),name='detail_brand_url'),
